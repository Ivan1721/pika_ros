...
def generate_launch_description():
    ...
    ld.add_action(Node(
            ...
            name=[name_index,TextSubstitution(text='gripper_serial_gripper_imu_l')],
            ...
            remappings=[
                ...
                ('/gripper/joint_state', [name,TextSubstitution(text='/gripper_l/gripper_joint_state')]),
                ('/gripper/joint_state_ctrl', '/gripper_l/joint_state'),
    ...
    ld.add_action(Node(
            package='sensor_tools',
            executable='serial_gripper_imu',
            name=[name_index,TextSubstitution(text='gripper_serial_gripper_imu_r')],
            ...
            remappings=[
                ...
                ('/gripper/joint_state', [name,TextSubstitution(text='/gripper_r/gripper_joint_state')]),
                ('/gripper/joint_state_ctrl', '/gripper_r/joint_state'),
